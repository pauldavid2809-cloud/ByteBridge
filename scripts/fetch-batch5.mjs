...
const accounts = [
  { slug: "dystopiabowling", handle: "dystopiabowling", name: "Dystopia Bowling", url: "https://www.instagram.com/dystopiabowling/" },
  { slug: "lataberna_delnavegante", handle: "lataberna_delnavegante", name: "La Taberna del Navegante", url: "https://www.instagram.com/lataberna_delnavegante/" },
  { slug: "mrbroastermcbo", handle: "mr.broastermcbo", name: "Mr. Broaster Maracaibo", url: "https://www.instagram.com/mr.broastermcbo/" },
  { slug: "friendsmaracaibo", handle: "friendsmaracaibo", name: "Friends Maracaibo", url: "https://www.instagram.com/friendsmaracaibo/" },
  { slug: "cartablancave", handle: "cartablanca.ve", name: "Carta Blanca Maracaibo", url: "https://www.instagram.com/cartablanca.ve/" },
  { slug: "pidesalmarina", handle: "pidesalmarina", name: "Sal Marina Seafood & Grill", url: "https://www.instagram.com/pidesalmarina/" },
  { slug: "picanagrill", handle: "picanagrill_", name: "Picaña Grill", url: "https://www.instagram.com/picanagrill_/" },
  { slug: "altamarmcbo", handle: "altamarmcbo", name: "Altamar Restaurante", url: "https://www.instagram.com/altamarmcbo/" },
  { slug: "bogrillmcbo", handle: "bogrillmcbo", name: "BO Grill Maracaibo", url: "https://www.instagram.com/bogrillmcbo/" },
  { slug: "dantedipronto", handle: "dantedipronto", name: "Dante Di Pronto", url: "https://www.instagram.com/dantedipronto/" }
];
...
async function main() {
  ...
  console.log("Iniciando Edge headless para descargar fotos y logos de Día 5 (10 cuentas)...");
